...
class SunglintCorrection:
    ...
    def sunglint_correction_rgb(self):
        ...
        fp_store_glint = join(self.stitch_hyperspectral_object.fp_store,glint_directory)
...
class GeotransformImage:
    ...
    def geotransform_image(self):
        ...
        if self.transform_predicted_image is True:
            ...
            fp_store_prediction = join(self.fp_store,prediction_directory)
...
# (image_folder_filepath,spectro_filepath,overlap_ratio,start_index,end_index,s1_bands_fp='s1_bands.csv',Reflectance_White_Ref=95):
    ...
    def calibration_attributes(self):
        ...
        """
        Dark_fp = self.image_folder_filepath + '/Dark'
        White_fp = self.image_folder_filepath + '/WhiteRef'
    ...
    def raw_attributes(self):
        ...
        fp = self.image_folder_filepath + '/' + 'RawImages'
        rawfiles = [f for f in sorted(listdir(fp)) if isfile(join(fp, f))]
    ...
    def generate_hyperspectral_images(self):
        ...
        """
        hyperspectral_directory = 'Hyperspectral'
        fp_store_hyperspectral = join(self.fp_store,hyperspectral_directory)
    ...
    def get_predicted_image(self,model,covariates_index_list,\
        ...
        glint_corrected_reflectance=None,reflectance=None,\
        ...
        img_fp = join(self.fp_store,prediction_directory,img_fp)
        img.save(img_fp)
        return #predicted_image---

    def get_reflectance_from_GPS(self,tss_lat,tss_lon,tss_measurements,\
        radius,mask = None,\
        glint_corrected_reflectance=None,\
    ...
    def get_mask(self,model,type="XGBoost"):
        ...
        mask_directory = 'Mask'
        fp_store_mask = join(self.fp_store,mask_directory)
        ...
        mask_fp = join(fp_store_mask,mask_fp)
